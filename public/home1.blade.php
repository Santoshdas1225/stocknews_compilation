            ...
            <div class="scrollable-container">
              <div class="scrollable-div">
                ...
                <div class="bg-white border border-top-0 p-3">
                  ...
                  <div class="row mb-3">
                    <div class="col-lg-12">
                      <a href="https://www.stockyfly.com/" target="_blank"><img src="{{asset('ad5.jpg')}}" alt="Ad" class="full-cover" style="height: 100px; "></a>
                    </div>
                  </div>
                  @endif
                  @if($count == 4)
                  <div class="row mb-3">
                    <div class="col-lg-12">
                      <a href="https://www.stockyfly.com/" target="_blank"><img src="{{asset('ad4.jpg')}}" alt="Ad" class="full-cover" style="height: 100px; "></a>
                    </div>
                  </div>
                  @endif
                  @if($count == 6)
                  <div class="row mb-3">
                    <div class="col-lg-12">
                      <a href="https://www.stockyfly.com/" target="_blank"><img src="{{asset('ad6.jpg')}}" alt="Ad" class="full-cover" style="height: 100px; "></a>
                    </div>
                  </div>
                  @endif
                  @if($count == 8)
                  <div class="row mb-3">
                    <div class="col-lg-12">
                      <a href="https://www.stockyfly.com/" target="_blank"><img src="{{asset('ad7.jpg')}}" alt="Ad" class="full-cover" style="height: 100px; "></a>
                    </div>
                  </div>
                  @endif
                  @if($count == 10)
                  <div class="row mb-3">
                    <div class="col-lg-12">
                      <a href="https://www.stockyfly.com/" target="_blank"><img src="{{asset('ad8.jpg')}}" alt="Ad" class="full-cover" style="height: 100px; "></a>
                    </div>
                  </div>
                  @endif
                  @endforeach
