    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 ">
      ...
      <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
          ...
          <div class="navbar-nav mr-auto py-0">
              ...
              <a href="CNBCTV18" class="nav-item nav-link active">CNBC-TV18</a>
...
<div class="container-fluid pt-5 mb-3">
    <div class="container">
        <div class="section-title">
            <h4 class="m-0 text-uppercase font-weight-bold">CNBCTV18</h4>
        </div>

        <div id="data-wrapper" class="container-fluid">
            <div class="row" id="news-items">
               @include('CNBCTV18show')
            </div>
        </div>
...
<script>
    var ENDPOINT = "{{ route('CNBCTV18load') }}";
    var page = 1;
