    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 ">
      ...
      <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
          ...
          <div class="navbar-nav mr-auto py-0">
              ...
              <a href="zeebusiness" class="nav-item nav-link active">Zee business</a>
...
<div class="container-fluid pt-5 mb-3">
    <div class="container">
        <div class="section-title">
            <h4 class="m-0 text-uppercase font-weight-bold">ZEE BUSINESS</h4>
        </div>

        <div id="data-wrapper" class="container-fluid">
            <div class="row" id="news-items">
                @include('zeebusinessshow')
            </div>
        </div>
        <div class="text-center" id="no-more-news" style="display:none; color: red">END</div>
